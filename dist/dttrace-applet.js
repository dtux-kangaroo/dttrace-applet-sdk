...
(function (global, factory) {
  ...
  var set$1 = function set$$1(name, value) {
    if (!name) {
      ...
      return _extends(options, defineProperty({}, name, value));
    }
  };
  var options$1 = {
    get: get$1,
  ...
  var get$2 = function get$$1(name) {
    var currentParams = Object(defaultParams, getSystemInfo(), {
      $user_id: options$1.get('getUserId')()
    }, customParams);
    if (name) {
      ...
      if (checkRequiredConfig(config)) {
        ...
        if (getSessionId !== undefined) {
          if (typeof getSessionId === 'function') {
            this.options.set('getSessionId', getSessionId);
          } else {
            warning('Expected the getSessionId in config to be a function');
          }
        }
        //全局参数
  ...
  function autoTrace(dttrace) {
    if (dttrace instanceof Dttrace) ; else {
